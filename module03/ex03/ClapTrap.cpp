...
/*   Updated: 2023/12/23 22:13:58 by lagonzal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void)
	: name("Larry") , hitPoints(10), energyPoints(10), attackDamage(0)
...
ClapTrap::ClapTrap(const ClapTrap& param)
	...
	energyPoints(param.getEnergyPoints()), attackDamage(param.getAttackDamage()) 
{
